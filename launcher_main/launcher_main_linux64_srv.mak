...
COMPILE_DEPENDANT_MAKEFILES := launcher_main_linux64_srv.mak $(MAKEFILE_BASE)
FORCEINCLUDES= 
DEFINES += -DVPC -DCSTRIKE_REL_BUILD=1 -DRAD_TELEMETRY_DISABLED -DDEBUG -D_DEBUG -DGNUC -DPOSIX -DCOMPILER_GCC -DMEMOVERRIDE_MODULE=launcher_main -D_DLL_EXT=.so -D_GLIBCXX_USE_CXX11_ABI=0 -DDEDICATED -D_LINUX -DLINUX -DPOSIX -D_POSIX -DEXENAME=csgo_linux64 -DGL_GLEXT_PROTOTYPES -DDX_TO_GL_ABSTRACTION -DUSE_SDL -D_DLL_EXT=.so -D_DLL_PREFIX=lib -D_EXTERNAL_DLL_EXT=.so -D_LINUX=1 -D_LINUXSTEAMRT64=1 -D_POSIX=1 -DLINUX=1 -DLINUX64=1 -DLINUXSTEAMRT64=1 -DPOSIX=1 -DPROJECTDIR=/home/universe/Downloads/cstrike15_src/launcher_main -DVPCGAME=csgo -DVPCGAMECAPS=CSGO 
...
#
$(OBJ_DIR)/_vpc_generated_scripts/custom_build_tools/_vpc_create_dirs: launcher_main_linux64_srv.mak | $(OBJ_DIR)/_create_dir
...
COMPILE_DEPENDANT_MAKEFILES := launcher_main_linux64_srv.mak $(MAKEFILE_BASE)
FORCEINCLUDES= 
DEFINES += -DVPC -DCSTRIKE_REL_BUILD=1 -DRAD_TELEMETRY_DISABLED -DNDEBUG -DGNUC -DPOSIX -DCOMPILER_GCC -DMEMOVERRIDE_MODULE=launcher_main -D_DLL_EXT=.so -D_GLIBCXX_USE_CXX11_ABI=0 -DDEDICATED -D_LINUX -DLINUX -DPOSIX -D_POSIX -DEXENAME=csgo_linux64 -DGL_GLEXT_PROTOTYPES -DDX_TO_GL_ABSTRACTION -DUSE_SDL -D_DLL_EXT=.so -D_DLL_PREFIX=lib -D_EXTERNAL_DLL_EXT=.so -D_LINUX=1 -D_LINUXSTEAMRT64=1 -D_POSIX=1 -DLINUX=1 -DLINUX64=1 -DLINUXSTEAMRT64=1 -DPOSIX=1 -DPROJECTDIR=/home/universe/Downloads/cstrike15_src/launcher_main -DVPCGAME=csgo -DVPCGAMECAPS=CSGO 
INCLUDEDIRS += ../common ../public ../public/tier0 ../public/tier1 ../thirdparty/SDL2 
CONFTYPE=exe
OUTPUTFILE=../../game/csgo_linux64
GAMEOUTPUTFILE=
