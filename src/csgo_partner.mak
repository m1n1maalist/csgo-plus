...
appframework : 
	...
	@+$(MAKE) -C /home/universe/csgo-plus/src/appframework -f appframework_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

bitmap : 
	@$(ECHO) "Building: bitmap"
	@+$(MAKE) -C /home/universe/csgo-plus/src/bitmap -f bitmap_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

bitmap_byteswap : 
	@$(ECHO) "Building: bitmap_byteswap"
	@+$(MAKE) -C /home/universe/csgo-plus/src/bitmap -f bitmap_byteswap_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

bonesetup : 
	@$(ECHO) "Building: bonesetup"
	@+$(MAKE) -C /home/universe/csgo-plus/src/bonesetup -f bonesetup_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

bsppack : interfaces lzma tier0 tier1 tier2 vstdlib 
	@$(ECHO) "Building: bsppack"
	@+$(MAKE) -C /home/universe/csgo-plus/src/utils/bsppack -f bsppack_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

Bzip2 : 
	@$(ECHO) "Building: Bzip2"
	@+$(MAKE) -C /home/universe/csgo-plus/src/utils/bzip2 -f bzip2_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

choreoobjects : 
	@$(ECHO) "Building: choreoobjects"
	@+$(MAKE) -C /home/universe/csgo-plus/src/choreoobjects -f choreoobjects_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)
...
Client_CSGO : bitmap bonesetup Bzip2 choreoobjects Dmxloader interfaces matsys_controls meshutils particles Raytrace resourcefile tier0 tier1 tier2 tier3 vgui_controls videocfg vpklib vstdlib vtf 
	...
	@+$(MAKE) -C /home/universe/csgo-plus/src/game/client -f client_linux64_srv_csgo.mak $(CLEANPARAM) SHELL=$(SHELL)

datacache : interfaces tier0 tier1 tier2 tier3 vstdlib 
	@$(ECHO) "Building: datacache"
	@+$(MAKE) -C /home/universe/csgo-plus/src/datacache -f datacache_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

Dedicated : appframework Dmxloader interfaces tier0 tier1 tier2 tier3 vpklib vstdlib 
	@$(ECHO) "Building: Dedicated"
	@+$(MAKE) -C /home/universe/csgo-plus/src/dedicated -f dedicated_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

Dmxloader : 
	@$(ECHO) "Building: Dmxloader"
	@+$(MAKE) -C /home/universe/csgo-plus/src/dmxloader -f dmxloader_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

engine : appframework bitmap Bzip2 Dmxloader interfaces quickhull tier0 tier1 tier2 tier3 vstdlib vtf 
	@$(ECHO) "Building: engine"
	@+$(MAKE) -C /home/universe/csgo-plus/src/engine -f engine_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

filesystem_stdio : interfaces tier0 tier1 tier2 vpklib vstdlib 
	@$(ECHO) "Building: filesystem_stdio"
	@+$(MAKE) -C /home/universe/csgo-plus/src/filesystem -f filesystem_stdio_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

havana_constraints : 
	@$(ECHO) "Building: havana_constraints"
	@+$(MAKE) -C /home/universe/csgo-plus/src/ivp/havana -f havana_constraints_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

hk_base : 
	@$(ECHO) "Building: hk_base"
	@+$(MAKE) -C /home/universe/csgo-plus/src/ivp/havana/havok/hk_base -f hk_base_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

hk_math : 
	@$(ECHO) "Building: hk_math"
	@+$(MAKE) -C /home/universe/csgo-plus/src/ivp/havana/havok/hk_math -f hk_math_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

inputsystem : interfaces tier0 tier1 tier2 vstdlib 
	@$(ECHO) "Building: inputsystem"
	@+$(MAKE) -C /home/universe/csgo-plus/src/inputsystem -f inputsystem_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

interfaces : 
	@$(ECHO) "Building: interfaces"
	@+$(MAKE) -C /home/universe/csgo-plus/src/interfaces -f interfaces_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

ivp_compactbuilder : 
	@$(ECHO) "Building: ivp_compactbuilder"
	@+$(MAKE) -C /home/universe/csgo-plus/src/ivp/ivp_compact_builder -f ivp_compactbuilder_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

ivp_physics : 
	@$(ECHO) "Building: ivp_physics"
	@+$(MAKE) -C /home/universe/csgo-plus/src/ivp/ivp_physics -f ivp_physics_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

launcher : appframework interfaces tier0 tier1 tier2 tier3 vstdlib 
	@$(ECHO) "Building: launcher"
	@+$(MAKE) -C /home/universe/csgo-plus/src/launcher -f launcher_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

launcher_main : interfaces tier1 
	@$(ECHO) "Building: launcher_main"
	@+$(MAKE) -C /home/universe/csgo-plus/src/launcher_main -f launcher_main_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

localize : interfaces tier0 tier1 tier2 vstdlib 
	@$(ECHO) "Building: localize"
	@+$(MAKE) -C /home/universe/csgo-plus/src/localize -f localize_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

lzma : 
	@$(ECHO) "Building: lzma"
	@+$(MAKE) -C /home/universe/csgo-plus/src/utils/lzma -f lzma_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

Matchmaking_CSGO : interfaces matchmakingbase tier0 tier1 tier2 tier3 vstdlib 
	@$(ECHO) "Building: Matchmaking_CSGO"
	@+$(MAKE) -C /home/universe/csgo-plus/src/matchmaking -f matchmaking_linux64_srv_csgo.mak $(CLEANPARAM) SHELL=$(SHELL)

Matchmaking_DS_CSGO : interfaces matchmakingbase_ds tier0 tier1 tier2 tier3 vstdlib 
	@$(ECHO) "Building: Matchmaking_DS_CSGO"
	@+$(MAKE) -C /home/universe/csgo-plus/src/matchmaking -f matchmaking_ds_linux64_srv_csgo.mak $(CLEANPARAM) SHELL=$(SHELL)

matchmakingbase : 
	@$(ECHO) "Building: matchmakingbase"
	@+$(MAKE) -C /home/universe/csgo-plus/src/matchmaking -f matchmakingbase_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

matchmakingbase_ds : 
	@$(ECHO) "Building: matchmakingbase_ds"
	@+$(MAKE) -C /home/universe/csgo-plus/src/matchmaking -f matchmakingbase_ds_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

materialsystem : bitmap interfaces shaderlib tier0 tier1 tier2 tier3 vstdlib vtf 
	@$(ECHO) "Building: materialsystem"
	@+$(MAKE) -C /home/universe/csgo-plus/src/materialsystem -f materialsystem_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

matsys_controls : 
	@$(ECHO) "Building: matsys_controls"
	@+$(MAKE) -C /home/universe/csgo-plus/src/vgui2/matsys_controls -f matsys_controls_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

meshutils : 
	@$(ECHO) "Building: meshutils"
	@+$(MAKE) -C /home/universe/csgo-plus/src/meshutils -f meshutils_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

particles : 
	@$(ECHO) "Building: particles"
	@+$(MAKE) -C /home/universe/csgo-plus/src/particles -f particles_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

quickhull : 
	@$(ECHO) "Building: quickhull"
	@+$(MAKE) -C /home/universe/csgo-plus/src/thirdparty/quickhull -f quickhull_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

Raytrace : 
	@$(ECHO) "Building: Raytrace"
	@+$(MAKE) -C /home/universe/csgo-plus/src/raytrace -f raytrace_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

resourcefile : 
	@$(ECHO) "Building: resourcefile"
	@+$(MAKE) -C /home/universe/csgo-plus/src/resourcefile -f resourcefile_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

responserules_runtime : 
	@$(ECHO) "Building: responserules_runtime"
	@+$(MAKE) -C /home/universe/csgo-plus/src/responserules/runtime -f responserules_runtime_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

ScaleformUI : bitmap interfaces tier0 tier1 tier2 tier3 vstdlib vtf 
	@$(ECHO) "Building: ScaleformUI"
	@+$(MAKE) -C /home/universe/csgo-plus/src/scaleformui -f scaleformui_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

SceneFileCache : interfaces tier0 tier1 vstdlib 
	@$(ECHO) "Building: SceneFileCache"
	@+$(MAKE) -C /home/universe/csgo-plus/src/scenefilecache -f scenefilecache_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)
...
Server_CSGO : bitmap bonesetup choreoobjects Dmxloader interfaces particles responserules_runtime tier0 tier1 tier2 tier3 vgui_controls vstdlib 
	...
	@+$(MAKE) -C /home/universe/csgo-plus/src/game/server -f server_linux64_srv_csgo.mak $(CLEANPARAM) SHELL=$(SHELL)

shaderapidx9 : bitmap Bzip2 interfaces tier0 tier1 tier2 videocfg vstdlib vtf 
	@$(ECHO) "Building: shaderapidx9"
	@+$(MAKE) -C /home/universe/csgo-plus/src/materialsystem/shaderapidx9 -f shaderapidx9_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

shaderapiempty : interfaces tier0 tier1 vstdlib 
	@$(ECHO) "Building: shaderapiempty"
	@+$(MAKE) -C /home/universe/csgo-plus/src/materialsystem/shaderapiempty -f shaderapiempty_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

shaderlib : 
	@$(ECHO) "Building: shaderlib"
	@+$(MAKE) -C /home/universe/csgo-plus/src/materialsystem/shaderlib -f shaderlib_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

soundemittersystem : interfaces tier0 tier1 tier2 vstdlib 
	@$(ECHO) "Building: soundemittersystem"
	@+$(MAKE) -C /home/universe/csgo-plus/src/soundemittersystem -f soundemittersystem_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

soundsystem_lowlevel : 
	@$(ECHO) "Building: soundsystem_lowlevel"
	@+$(MAKE) -C /home/universe/csgo-plus/src/soundsystem/lowlevel -f soundsystem_lowlevel_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

stdshader_dx9 : interfaces shaderlib tier0 tier1 vstdlib 
	@$(ECHO) "Building: stdshader_dx9"
	@+$(MAKE) -C /home/universe/csgo-plus/src/materialsystem/stdshaders -f stdshader_dx9_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

studiorender : bitmap interfaces tier0 tier1 tier2 tier3 vstdlib 
	@$(ECHO) "Building: studiorender"
	@+$(MAKE) -C /home/universe/csgo-plus/src/studiorender -f studiorender_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

tier0 : 
	@$(ECHO) "Building: tier0"
	@+$(MAKE) -C /home/universe/csgo-plus/src/tier0 -f tier0_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

tier1 : 
	@$(ECHO) "Building: tier1"
	@+$(MAKE) -C /home/universe/csgo-plus/src/tier1 -f tier1_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

tier2 : 
	@$(ECHO) "Building: tier2"
	@+$(MAKE) -C /home/universe/csgo-plus/src/tier2 -f tier2_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

tier3 : 
	@$(ECHO) "Building: tier3"
	@+$(MAKE) -C /home/universe/csgo-plus/src/tier3 -f tier3_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

valve_avi : interfaces tier0 tier1 tier2 tier3 vstdlib 
	@$(ECHO) "Building: valve_avi"
	@+$(MAKE) -C /home/universe/csgo-plus/src/avi -f valve_avi_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

VAudio_Miles : interfaces tier0 tier1 vstdlib 
	@$(ECHO) "Building: VAudio_Miles"
	@+$(MAKE) -C /home/universe/csgo-plus/src/engine/voice_codecs/miles -f vaudio_miles_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

vgui_controls : 
	@$(ECHO) "Building: vgui_controls"
	@+$(MAKE) -C /home/universe/csgo-plus/src/vgui2/vgui_controls -f vgui_controls_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

vgui_surfacelib : 
	@$(ECHO) "Building: vgui_surfacelib"
	@+$(MAKE) -C /home/universe/csgo-plus/src/vgui2/vgui_surfacelib -f vgui_surfacelib_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

vgui2 : interfaces tier0 tier1 tier2 tier3 vgui_surfacelib vstdlib 
	@$(ECHO) "Building: vgui2"
	@+$(MAKE) -C /home/universe/csgo-plus/src/vgui2/src -f vgui_dll_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)
...
vguimatsurface : bitmap Dmxloader interfaces tier0 tier1 tier2 tier3 vgui_controls vgui_surfacelib vstdlib 
	...
	@+$(MAKE) -C /home/universe/csgo-plus/src/vguimatsurface -f vguimatsurface_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

videocfg : 
	@$(ECHO) "Building: videocfg"
	@+$(MAKE) -C /home/universe/csgo-plus/src/videocfg -f videocfg_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)
...
vphysics : havana_constraints hk_base hk_math interfaces ivp_compactbuilder ivp_physics tier0 tier1 tier2 vstdlib 
	...
	@+$(MAKE) -C /home/universe/csgo-plus/src/vphysics -f vphysics_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

vpklib : 
	@$(ECHO) "Building: vpklib"
	@+$(MAKE) -C /home/universe/csgo-plus/src/vpklib -f vpklib_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

vscript : interfaces tier0 tier1 vstdlib 
	@$(ECHO) "Building: vscript"
	@+$(MAKE) -C /home/universe/csgo-plus/src/vscript -f vscript_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

vstdlib : interfaces tier0 tier1 
	@$(ECHO) "Building: vstdlib"
	@+$(MAKE) -C /home/universe/csgo-plus/src/vstdlib -f vstdlib_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)

vtf : 
	@$(ECHO) "Building: vtf"
	@+$(MAKE) -C /home/universe/csgo-plus/src/vtf -f vtf_linux64_srv.mak $(CLEANPARAM) SHELL=$(SHELL)
