...
appframework : 
	...
	@+$(MAKE) -C /home/universe/csgo-plus/appframework -f appframework_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)

bitmap : 
	@$(ECHO) "Building: bitmap"
	@+$(MAKE) -C /home/universe/csgo-plus/bitmap -f bitmap_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)

bitmap_byteswap : 
	@$(ECHO) "Building: bitmap_byteswap"
	@+$(MAKE) -C /home/universe/csgo-plus/bitmap -f bitmap_byteswap_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)
...
Bzip2 : 
	@$(ECHO) "Building: Bzip2"
	@+$(MAKE) -C /home/universe/csgo-plus/utils/bzip2 -f bzip2_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)
...
Dedicated_main : 
	...
	@+$(MAKE) -C /home/universe/csgo-plus/dedicated_main -f dedicated_main_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)
...
Fgdlib : 
	...
	@+$(MAKE) -C /home/universe/csgo-plus/fgdlib -f fgdlib_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)
...
gcsdk_gc : 
	...
	@+$(MAKE) -C /home/universe/csgo-plus/gcsdk -f gcsdk_gc_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)

havana_constraints : 
	@$(ECHO) "Building: havana_constraints"
	@+$(MAKE) -C /home/universe/csgo-plus/ivp/havana -f havana_constraints_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)

hk_base : 
	@$(ECHO) "Building: hk_base"
	@+$(MAKE) -C /home/universe/csgo-plus/ivp/havana/havok/hk_base -f hk_base_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)
...
interfaces : 
	...
	@+$(MAKE) -C /home/universe/csgo-plus/interfaces -f interfaces_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)

ivp_compactbuilder : 
	@$(ECHO) "Building: ivp_compactbuilder"
	@+$(MAKE) -C /home/universe/csgo-plus/ivp/ivp_compact_builder -f ivp_compactbuilder_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)
...
launcher : appframework interfaces tier0 tier1 tier2 tier3 vstdlib 
	...
	@+$(MAKE) -C /home/universe/csgo-plus/launcher -f launcher_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)

launcher_main : interfaces tier1 
	@$(ECHO) "Building: launcher_main"
	@+$(MAKE) -C /home/universe/csgo-plus/launcher_main -f launcher_main_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)

localize : interfaces tier0 tier1 tier2 vstdlib 
	@$(ECHO) "Building: localize"
	@+$(MAKE) -C /home/universe/csgo-plus/localize -f localize_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)
...
matsys_controls : 
	...
	@+$(MAKE) -C /home/universe/csgo-plus/vgui2/matsys_controls -f matsys_controls_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)

meshutils : 
	@$(ECHO) "Building: meshutils"
	@+$(MAKE) -C /home/universe/csgo-plus/meshutils -f meshutils_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)

particles : 
	@$(ECHO) "Building: particles"
	@+$(MAKE) -C /home/universe/csgo-plus/particles -f particles_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)

quickhull : 
	@$(ECHO) "Building: quickhull"
	@+$(MAKE) -C /home/universe/csgo-plus/thirdparty/quickhull -f quickhull_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)

Raytrace : 
	@$(ECHO) "Building: Raytrace"
	@+$(MAKE) -C /home/universe/csgo-plus/raytrace -f raytrace_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)

resourcefile : 
	@$(ECHO) "Building: resourcefile"
	@+$(MAKE) -C /home/universe/csgo-plus/resourcefile -f resourcefile_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)
...
shaderapiempty : interfaces tier0 tier1 vstdlib 
	...
	@+$(MAKE) -C /home/universe/csgo-plus/materialsystem/shaderapiempty -f shaderapiempty_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)

shaderlib : 
	@$(ECHO) "Building: shaderlib"
	@+$(MAKE) -C /home/universe/csgo-plus/materialsystem/shaderlib -f shaderlib_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)

soundemittersystem : interfaces tier0 tier1 tier2 vstdlib 
	@$(ECHO) "Building: soundemittersystem"
	@+$(MAKE) -C /home/universe/csgo-plus/soundemittersystem -f soundemittersystem_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)

soundsystem_lowlevel : 
	@$(ECHO) "Building: soundsystem_lowlevel"
	@+$(MAKE) -C /home/universe/csgo-plus/soundsystem/lowlevel -f soundsystem_lowlevel_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)
...
tier0 : 
	@$(ECHO) "Building: tier0"
	@+$(MAKE) -C /home/universe/csgo-plus/tier0 -f tier0_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)

tier1 : 
	@$(ECHO) "Building: tier1"
	@+$(MAKE) -C /home/universe/csgo-plus/tier1 -f tier1_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)

tier2 : 
	@$(ECHO) "Building: tier2"
	@+$(MAKE) -C /home/universe/csgo-plus/tier2 -f tier2_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)

tier3 : 
	@$(ECHO) "Building: tier3"
	@+$(MAKE) -C /home/universe/csgo-plus/tier3 -f tier3_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)

valve_avi : interfaces tier0 tier1 tier2 tier3 vstdlib 
	@$(ECHO) "Building: valve_avi"
	@+$(MAKE) -C /home/universe/csgo-plus/avi -f valve_avi_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)

VAudio_Miles : interfaces tier0 tier1 vstdlib 
	@$(ECHO) "Building: VAudio_Miles"
	@+$(MAKE) -C /home/universe/csgo-plus/engine/voice_codecs/miles -f vaudio_miles_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)

vgui_controls : 
	@$(ECHO) "Building: vgui_controls"
	@+$(MAKE) -C /home/universe/csgo-plus/vgui2/vgui_controls -f vgui_controls_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)

vgui_surfacelib : 
	@$(ECHO) "Building: vgui_surfacelib"
	@+$(MAKE) -C /home/universe/csgo-plus/vgui2/vgui_surfacelib -f vgui_surfacelib_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)
...
vstdlib : interfaces tier0 tier1 
	...
	@+$(MAKE) -C /home/universe/csgo-plus/vstdlib -f vstdlib_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)

vtf : 
	@$(ECHO) "Building: vtf"
	@+$(MAKE) -C /home/universe/csgo-plus/vtf -f vtf_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)
