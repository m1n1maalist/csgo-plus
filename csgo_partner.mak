...
all-targets : appframework valve_avi bitmap bitmap_byteswap bonesetup choreoobjects datacache Datamodel Dedicated Dedicated_main Dmserializers Dmxloader engine engine_ds Fgdlib filesystem_stdio Client_CSGO Server_CSGO inputsystem interfaces launcher launcher_main Matchmaking_CSGO matchmakingbase Matchmaking_DS_CSGO matchmakingbase_ds materialsystem shaderapiempty shaderlib stdshader_dbg stdshader_dx9 mathlib mathlib_extended meshutils Movieobjects particles Raytrace resourcefile responserules_runtime SceneFileCache ServerBrowser soundemittersystem soundsystem_lowlevel studiorender quickhull tier0 tier1 tier2 tier3 game_controls matsys_controls vgui2 vgui_controls vgui_surfacelib vguimatsurface Unitlib localize Bzip2 videocfg vpklib vscript vstdlib vtf 
...
Datamodel : 
	...
	@+$(MAKE) -C /home/universe/Downloads/cstrike15_src/datamodel -f datamodel_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)
...
Dmserializers : 
	...
	@+$(MAKE) -C /home/universe/Downloads/cstrike15_src/dmserializers -f dmserializers_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)
...
engine_ds : appframework bitmap Dmxloader interfaces mathlib soundsystem_lowlevel quickhull tier0 tier1 tier2 tier3 matsys_controls vgui_controls Bzip2 videocfg vstdlib vtf 
	...
	@+$(MAKE) -C /home/universe/Downloads/cstrike15_src/engine_ds -f engine_ds_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)
...
Movieobjects : 
	...
	@+$(MAKE) -C /home/universe/Downloads/cstrike15_src/movieobjects -f movieobjects_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)
...
ServerBrowser : Dmxloader interfaces mathlib tier0 tier1 tier2 tier3 vgui_controls vstdlib 
	...
	@+$(MAKE) -C /home/universe/Downloads/cstrike15_src/serverbrowser -f serverbrowser_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)
...
game_controls : 
	...
	@+$(MAKE) -C /home/universe/Downloads/cstrike15_src/vgui2/game_controls -f game_controls_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)
...
Unitlib : interfaces tier0 tier1 vstdlib 
	...
	@+$(MAKE) -C /home/universe/Downloads/cstrike15_src/unitlib -f unitlib_linux64.mak $(CLEANPARAM) SHELL=$(SHELL)
...
showregen: 
	@$(ECHO) devtools/bin/vpc_linux /csgo +csgo_partner /linux64 /mksln csgo_partner 
